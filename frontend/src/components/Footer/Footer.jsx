...
const Footer = () => {
  return (
    <div className='footer-container'>
        ...
        <Flex gap={4} justifyContent={"space-between"} direction={{base:"column",sm:"column",md:"column",lg:"row"}} >
  ...
  <Button fontSize={{base:"10px",sm:"16px",md:"16px"}} background={'orange.400'} mt={3} ml={3} color='white'>SUBMIT</Button>
    ...
    <p><ImInstagram/></p>
      ...
      <Flex  direction={{base:"column",sm:"column",md:"column",lg:"row"}} justifyContent={"space-between"} >

        <Flex padding={2} gap={50} mt={4}  direction={{base:"column",sm:"column",md:"column",lg:"row"}} justifyContent={"space-between"} >
